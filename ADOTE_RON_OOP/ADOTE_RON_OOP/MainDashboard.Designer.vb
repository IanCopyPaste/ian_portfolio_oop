...
Partial Class MainDashboard
    ...
    Private Sub InitializeComponent()
        ...
        WEEKLYERRANDSToolStripMenuItem = New ToolStripMenuItem()
        ToolStripMenuItem2 = New ToolStripMenuItem()
        WEEK2ToolStripMenuItem = New ToolStripMenuItem()
        WEEK3ToolStripMenuItem = New ToolStripMenuItem()
        WEEK4ToolStripMenuItem = New ToolStripMenuItem()
        WEEK5ToolStripMenuItem = New ToolStripMenuItem()
        ...
        MenuStrip1.Items.AddRange(New ToolStripItem() {WEEKLYERRANDSToolStripMenuItem, DEVSPREFRENCEToolStripMenuItem, EXITToolStripMenuItem})
        ...
        WEEKLYERRANDSToolStripMenuItem.Name = "WEEKLYERRANDSToolStripMenuItem"
        WEEKLYERRANDSToolStripMenuItem.Size = New Size(134, 20)
        WEEKLYERRANDSToolStripMenuItem.Text = "Weekly Errands"
        ' 
        ' ToolStripMenuItem2
        ' 
        ...
        ' 
        EXITToolStripMenuItem.Font = New Font("Arial", 9.75F, FontStyle.Bold)
        EXITToolStripMenuItem.ForeColor = SystemColors.ButtonHighlight
        EXITToolStripMenuItem.Name = "EXITToolStripMenuItem"
        EXITToolStripMenuItem.Size = New Size(43, 20)
        ...
        Label1.Font = New Font("Trebuchet MS", 48F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label1.ForeColor = Color.Transparent
        Label1.Location = New Point(27, 162)
        Label1.Name = "Label1"
        Label1.Size = New Size(480, 243)
        Label1.TabIndex = 1
        Label1.Text = "OBJECT " & vbCrLf & "ORIENTED" & vbCrLf & "PROGRAMMING"
        ...
        Label2.Font = New Font("Calisto MT", 18F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label2.ForeColor = Color.White
        Label2.Location = New Point(47, 456)
        Label2.Name = "Label2"
        Label2.Size = New Size(280, 28)
        Label2.TabIndex = 2
        Label2.Text = "by Ron Adrian M. Adote"
        ...
        PictureBox1.Size = New Size(958, 540)
    ...
    Friend WithEvents WEEKLYERRANDSToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ToolStripMenuItem2 As ToolStripMenuItem
    Friend WithEvents WEEK2ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents WEEK3ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents WEEK4ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents WEEK5ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Label1 As Label
    Friend WithEvents DEVSPREFRENCEToolStripMenuItem As ToolStripMenuItem
