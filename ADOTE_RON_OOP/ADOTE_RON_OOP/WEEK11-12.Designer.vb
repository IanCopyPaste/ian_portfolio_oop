...
Partial Class WEEK11_12
    ...
    Private Sub InitializeComponent()
        ...
        ' FormatPercentPanel
        ' 
        FormatPercentPanel.BackColor = Color.FromArgb(CByte(255), CByte(192), CByte(255))
        FormatPercentPanel.Controls.Add(percentBtn)
        FormatPercentPanel.Controls.Add(txtPercent)
        FormatPercentPanel.Controls.Add(num06)
        FormatPercentPanel.Controls.Add(Label34)
        FormatPercentPanel.Controls.Add(num05)
        FormatPercentPanel.Controls.Add(Label35)
        FormatPercentPanel.Controls.Add(num04)
        FormatPercentPanel.Controls.Add(Label36)
        FormatPercentPanel.Controls.Add(num03)
        FormatPercentPanel.Controls.Add(Label37)
        FormatPercentPanel.Controls.Add(num02)
        FormatPercentPanel.Controls.Add(Label38)
        ...
        ' percentBtn
        ' 
        percentBtn.BackColor = Color.FromArgb(CByte(255), CByte(128), CByte(255))
        percentBtn.FlatAppearance.BorderColor = Color.FromArgb(CByte(255), CByte(128), CByte(255))
        percentBtn.FlatAppearance.MouseDownBackColor = Color.Purple
        percentBtn.FlatAppearance.MouseOverBackColor = Color.Fuchsia
        percentBtn.FlatStyle = FlatStyle.Popup
        percentBtn.Font = New Font("Tahoma", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        percentBtn.ForeColor = Color.Black
        percentBtn.Location = New Point(193, 25)
        percentBtn.Name = "percentBtn"
        percentBtn.Size = New Size(63, 24)
        percentBtn.TabIndex = 19
        percentBtn.Text = "Convert"
        percentBtn.UseVisualStyleBackColor = False
        ' 
        ' txtPercent
        ' 
        txtPercent.Location = New Point(20, 25)
        txtPercent.Name = "txtPercent"
        txtPercent.PlaceholderText = "Enter Percent"
        txtPercent.Size = New Size(161, 23)
        txtPercent.TabIndex = 44
        ' 
        ' num06
        ' 
        num06.Location = New Point(314, 357)
        num06.Name = "num06"
        num06.Size = New Size(250, 23)
        num06.TabIndex = 43
        ' 
        ' Label34
        ' 
        ...
        Label34.Location = New Point(46, 357)
        Label34.Name = "Label34"
        Label34.Size = New Size(264, 21)
        Label34.TabIndex = 42
        Label34.Text = "FormatPercent(0.045, 3, vbFalse) = "
        ' 
        ' num05
        ' 
        num05.Location = New Point(314, 302)
        num05.Name = "num05"
        num05.Size = New Size(250, 23)
        num05.TabIndex = 41
        ' 
        ' Label35
        ' 
        Label35.AutoSize = True
        Label35.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label35.ForeColor = Color.Black
        Label35.Location = New Point(46, 302)
        Label35.Name = "Label35"
        Label35.Size = New Size(261, 21)
        Label35.TabIndex = 40
        Label35.Text = "FormatPercent(0.045, 3, vbTrue) = "
        ' 
        ' num04
        ' 
        num04.Location = New Point(314, 245)
        num04.Name = "num04"
        num04.Size = New Size(250, 23)
        num04.TabIndex = 39
        ' 
        ' Label36
        ' 
        ...
        Label36.Location = New Point(46, 245)
        Label36.Name = "Label36"
        Label36.Size = New Size(266, 21)
        Label36.TabIndex = 38
        Label36.Text = "FormatPercent(-0.25, 2, , vbTrue) = "
        ' 
        ' num03
        ' 
        num03.Location = New Point(314, 186)
        num03.Name = "num03"
        num03.Size = New Size(250, 23)
        num03.TabIndex = 37
        ' 
        ' Label37
        ' 
        Label37.AutoSize = True
        Label37.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label37.ForeColor = Color.Black
        Label37.Location = New Point(46, 186)
        Label37.Name = "Label37"
        Label37.Size = New Size(201, 21)
        Label37.TabIndex = 36
        Label37.Text = "FormatPercent(value, 0) = "
        ' 
        ' num02
        ' 
        num02.Location = New Point(314, 129)
        num02.Name = "num02"
        num02.Size = New Size(250, 23)
        num02.TabIndex = 35
        ' 
        ' Label38
        ' 
        Label38.AutoSize = True
        Label38.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label38.ForeColor = Color.Black
        Label38.Location = New Point(46, 129)
        Label38.Name = "Label38"
        Label38.Size = New Size(198, 21)
        Label38.TabIndex = 34
        Label38.Text = "FormatPercent(value, 1) = "
        ' 
        ' num01
        ' 
        num01.Location = New Point(314, 71)
        num01.Name = "num01"
        num01.Size = New Size(250, 23)
        num01.TabIndex = 33
        ' 
        ' Label39
        ' 
        Label39.AutoSize = True
        Label39.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label39.ForeColor = Color.Black
        Label39.Location = New Point(43, 71)
        Label39.Name = "Label39"
        Label39.Size = New Size(184, 21)
        Label39.TabIndex = 32
        Label39.Text = "FormatPercent(value) = "
        ' 
        ' Label40
        ' 
        Label40.AutoSize = True
        Label40.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label40.ForeColor = Color.Black
        Label40.Location = New Point(502, 0)
        Label40.Name = "Label40"
        Label40.Size = New Size(121, 21)
        Label40.TabIndex = 31
        ...
        FormatNumberPanel.Controls.Add(Button2)
        FormatNumberPanel.Controls.Add(txtNum)
        FormatNumberPanel.Controls.Add(num6)
        FormatNumberPanel.Controls.Add(Label33)
        FormatNumberPanel.Controls.Add(num5)
        FormatNumberPanel.Controls.Add(Label27)
        FormatNumberPanel.Controls.Add(num4)
        FormatNumberPanel.Controls.Add(Label28)
        FormatNumberPanel.Controls.Add(num3)
        FormatNumberPanel.Controls.Add(Label29)
        FormatNumberPanel.Controls.Add(num2)
        FormatNumberPanel.Controls.Add(Label30)
        ...
        Button2.Location = New Point(193, 25)
        ...
        ' txtNum
        ' 
        txtNum.Location = New Point(20, 25)
        txtNum.Name = "txtNum"
        txtNum.PlaceholderText = "Enter Number"
        txtNum.Size = New Size(161, 23)
        txtNum.TabIndex = 44
        ' 
        ' num6
        ' 
        num6.Location = New Point(318, 357)
        num6.Name = "num6"
        num6.Size = New Size(250, 23)
        num6.TabIndex = 43
        ' 
        ' Label33
        ' 
        ...
        Label33.Location = New Point(20, 356)
        Label33.Name = "Label33"
        Label33.Size = New Size(275, 21)
        Label33.TabIndex = 42
        Label33.Text = "FormatNumbers(0.75, 2 ,  vbFalse) = "
        ' 
        ' num5
        ' 
        num5.Location = New Point(318, 302)
        num5.Name = "num5"
        num5.Size = New Size(250, 23)
        num5.TabIndex = 41
        ' 
        ' Label27
        ' 
        ...
        Label27.Location = New Point(20, 301)
        Label27.Name = "Label27"
        Label27.Size = New Size(266, 21)
        Label27.TabIndex = 40
        Label27.Text = "FormayNumbers(0.75, 2, vbTrue) = "
        ' 
        ' num4
        ' 
        num4.Location = New Point(318, 245)
        num4.Name = "num4"
        num4.Size = New Size(250, 23)
        num4.TabIndex = 39
        ' 
        ' Label28
        ' 
        ...
        Label28.Location = New Point(20, 244)
        Label28.Name = "Label28"
        Label28.Size = New Size(283, 21)
        Label28.TabIndex = 38
        Label28.Text = "FormatNumbers(-5000, 2,  ,vbTrue) = "
        ' 
        ' num3
        ' 
        num3.Location = New Point(318, 186)
        num3.Name = "num3"
        num3.Size = New Size(250, 23)
        num3.TabIndex = 37
        ' 
        ' Label29
        ' 
        Label29.AutoSize = True
        Label29.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label29.ForeColor = Color.Black
        Label29.Location = New Point(20, 185)
        Label29.Name = "Label29"
        Label29.Size = New Size(207, 21)
        Label29.TabIndex = 36
        Label29.Text = "FormatNumbers(num, 0) = "
        ' 
        ' num2
        ' 
        num2.Location = New Point(318, 129)
        num2.Name = "num2"
        num2.Size = New Size(250, 23)
        num2.TabIndex = 35
        ' 
        ' Label30
        ' 
        ...
        Label30.Location = New Point(20, 128)
        Label30.Name = "Label30"
        Label30.Size = New Size(207, 21)
        Label30.TabIndex = 34
        Label30.Text = "FormatNumbers(num, 3) = "
        ' 
        ' num1
        ' 
        num1.Location = New Point(315, 71)
        num1.Name = "num1"
        num1.Size = New Size(250, 23)
        num1.TabIndex = 33
        ' 
        ' Label31
        ' 
        Label31.AutoSize = True
        Label31.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label31.ForeColor = Color.Black
        Label31.Location = New Point(17, 70)
        Label31.Name = "Label31"
        Label31.Size = New Size(190, 21)
        Label31.TabIndex = 32
        Label31.Text = "FormatNumbers(num) = "
        ' 
        ' Label32
        ' 
        ...
        Label32.Location = New Point(492, 0)
        Label32.Name = "Label32"
        Label32.Size = New Size(133, 21)
        Label32.TabIndex = 31
        Label32.Text = "Format Numbers"
        ' 
        ' FormatPanel
        ' 
        FormatPanel.BackColor = Color.FromArgb(CByte(255), CByte(192), CByte(255))
        FormatPanel.Controls.Add(Label19)
        ...
        Label19.Location = New Point(561, 0)
        Label19.Name = "Label19"
        Label19.Size = New Size(62, 21)
        Label19.TabIndex = 30
        Label19.Text = "Format"
        ' 
        ' Label12
        ...
        Label12.Location = New Point(164, 299)
        Label12.Name = "Label12"
        Label12.Size = New Size(270, 21)
        Label12.TabIndex = 29
        Label12.Text = "Used a Format(date,""yyyy-MM-dd"")"
        ' 
        ' MonthCalendar1
        ' 
        MonthCalendar1.BackColor = Color.FromArgb(CByte(255), CByte(192), CByte(128))
        MonthCalendar1.Location = New Point(193, 30)
        ...
        ' formatbox
        ' 
        formatbox.Font = New Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        formatbox.Location = New Point(164, 225)
        formatbox.Name = "formatbox"
        formatbox.PlaceholderText = "Date"
        formatbox.ReadOnly = True
        formatbox.Size = New Size(281, 29)
        formatbox.TabIndex = 1
        formatbox.TextAlign = HorizontalAlignment.Center
        ' 
        ' FormatDateTimePanel
        ' 
        FormatDateTimePanel.BackColor = Color.FromArgb(CByte(255), CByte(192), CByte(255))
        FormatDateTimePanel.Controls.Add(STime)
        FormatDateTimePanel.Controls.Add(Label26)
        FormatDateTimePanel.Controls.Add(LTime)
        FormatDateTimePanel.Controls.Add(Label25)
        FormatDateTimePanel.Controls.Add(SDate)
        FormatDateTimePanel.Controls.Add(Label24)
        FormatDateTimePanel.Controls.Add(LDate)
        FormatDateTimePanel.Controls.Add(Label23)
        ...
        ' STime
        ' 
        STime.Location = New Point(318, 323)
        STime.Name = "STime"
        STime.Size = New Size(250, 23)
        STime.TabIndex = 41
        ' 
        ' Label26
        ' 
        ...
        Label26.Location = New Point(20, 322)
        Label26.Name = "Label26"
        Label26.Size = New Size(279, 21)
        Label26.TabIndex = 40
        Label26.Text = "FormatDateTime(dt, vbShortTime) = "
        ' 
        ' LTime
        ' 
        LTime.Location = New Point(318, 266)
        LTime.Name = "LTime"
        LTime.Size = New Size(250, 23)
        LTime.TabIndex = 39
        ' 
        ' Label25
        ' 
        ...
        Label25.Location = New Point(20, 265)
        Label25.Name = "Label25"
        Label25.Size = New Size(276, 21)
        Label25.TabIndex = 38
        Label25.Text = "FormatDateTime(dt, vbLongTime) = "
        ' 
        ' SDate
        ' 
        SDate.Location = New Point(318, 207)
        SDate.Name = "SDate"
        SDate.Size = New Size(250, 23)
        SDate.TabIndex = 37
        ' 
        ' Label24
        ' 
        ...
        Label24.Location = New Point(20, 206)
        Label24.Name = "Label24"
        Label24.Size = New Size(277, 21)
        Label24.TabIndex = 36
        Label24.Text = "FormatDateTime(dt, vbShortDate) = "
        ' 
        ' LDate
        ' 
        LDate.Location = New Point(318, 150)
        LDate.Name = "LDate"
        LDate.Size = New Size(250, 23)
        LDate.TabIndex = 35
        ' 
        ' Label23
        ' 
        ...
        Label23.Location = New Point(20, 149)
        Label23.Name = "Label23"
        Label23.Size = New Size(274, 21)
        Label23.TabIndex = 34
        Label23.Text = "FormatDateTime(dt, vbLongDate) = "
        ' 
        ' genDate
        ' 
        genDate.Location = New Point(315, 92)
        genDate.Name = "genDate"
        genDate.Size = New Size(250, 23)
        genDate.TabIndex = 33
        ' 
        ' Label22
        ' 
        ...
        Label22.Location = New Point(17, 91)
        Label22.Name = "Label22"
        Label22.Size = New Size(293, 21)
        Label22.TabIndex = 32
        Label22.Text = "FormatDateTime(dt, vbGeneralDate) = "
        ' 
        ' Label21
        ' 
        ...
        Label21.Location = New Point(449, 0)
        Label21.Name = "Label21"
        Label21.Size = New Size(174, 21)
        Label21.TabIndex = 31
        Label21.Text = "Format Date And Time"
        ' 
        ' FormatCurPanel
        ' 
        FormatCurPanel.BackColor = Color.FromArgb(CByte(255), CByte(192), CByte(255))
        FormatCurPanel.Controls.Add(Label20)
        FormatCurPanel.Controls.Add(Label15)
        FormatCurPanel.Controls.Add(Label14)
        FormatCurPanel.Controls.Add(Label13)
        ...
        Label20.Location = New Point(492, 0)
        Label20.Name = "Label20"
        Label20.Size = New Size(131, 21)
        Label20.TabIndex = 31
        Label20.Text = "Format Currency"
        ' 
        ' Label15
        ' 
        ...
        Label15.Location = New Point(361, 209)
        Label15.Name = "Label15"
        Label15.Size = New Size(126, 16)
        Label15.TabIndex = 30
        Label15.Text = "Converted Number"
        ' 
        ' Label14
        ' 
        ...
        Label14.Location = New Point(111, 210)
        Label14.Name = "Label14"
        Label14.Size = New Size(105, 16)
        Label14.TabIndex = 29
        Label14.Text = "Input a Number"
        ' 
        ' Label13
        ' 
        Label13.AutoSize = True
        Label13.Location = New Point(279, 182)
        ...
        ' conv
        ' 
        conv.BackColor = Color.FromArgb(CByte(255), CByte(128), CByte(255))
        conv.FlatAppearance.BorderColor = Color.FromArgb(CByte(255), CByte(128), CByte(255))
        conv.FlatAppearance.MouseDownBackColor = Color.Purple
        conv.FlatAppearance.MouseOverBackColor = Color.Fuchsia
        conv.FlatStyle = FlatStyle.Popup
        conv.Font = New Font("Arial", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        conv.ForeColor = Color.Black
        conv.Location = New Point(206, 277)
        conv.Name = "conv"
        conv.Size = New Size(167, 29)
        conv.TabIndex = 19
        conv.Text = "Convert"
        ...
        ' priceResult
        ' 
        priceResult.Font = New Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        priceResult.Location = New Point(317, 177)
        priceResult.Name = "priceResult"
        priceResult.PlaceholderText = "Converted Price"
        priceResult.ReadOnly = True
        priceResult.Size = New Size(193, 25)
        priceResult.TabIndex = 27
        ' 
        ' txtPrice
        ' 
        txtPrice.Font = New Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        txtPrice.Location = New Point(76, 177)
        ...
        ' timerforFormatDT
        ' 
        timerforFormatDT.Enabled = True
        timerforFormatDT.Interval = 1000
        ' 
        ' WEEK11_12
        ' 
        ...
        FormatDateTimePanel.ResumeLayout(False)
    ...
    Friend WithEvents AddItems As ListBox
    Friend WithEvents FilterItems As ListBox
    Friend WithEvents txtAddItems As TextBox
    Friend WithEvents addBtn As Button
    Friend WithEvents filtbtn As Button
    Friend WithEvents txtFilterItems As TextBox
    Friend WithEvents Label11 As Label
    Friend WithEvents Label10 As Label
    Friend WithEvents FormatPanel As Panel
    Friend WithEvents MonthCalendar1 As MonthCalendar
    Friend WithEvents formatbox As TextBox
    Friend WithEvents Label12 As Label
    Friend WithEvents FormatCurPanel As Panel
    Friend WithEvents conv As Button
    Friend WithEvents priceResult As TextBox
    ...
    Friend WithEvents timerforFormatDT As Timer
    Friend WithEvents FormatDateTimePanel As Panel
    Friend WithEvents Label21 As Label
    Friend WithEvents STime As TextBox
    Friend WithEvents Label26 As Label
    Friend WithEvents LTime As TextBox
    Friend WithEvents Label25 As Label
    Friend WithEvents SDate As TextBox
    Friend WithEvents Label24 As Label
    Friend WithEvents LDate As TextBox
    Friend WithEvents Label23 As Label
    Friend WithEvents genDate As TextBox
    Friend WithEvents Label22 As Label
    Friend WithEvents FormatNumberPanel As Panel
    Friend WithEvents Label32 As Label
    Friend WithEvents Button2 As Button
    Friend WithEvents txtNum As TextBox
    Friend WithEvents num6 As TextBox
    ...
    Friend WithEvents FormatPercentPanel As Panel
    Friend WithEvents percentBtn As Button
    Friend WithEvents txtPercent As TextBox
    Friend WithEvents num06 As TextBox
    Friend WithEvents Label34 As Label
    Friend WithEvents num05 As TextBox
    Friend WithEvents Label35 As Label
    Friend WithEvents num04 As TextBox
    Friend WithEvents Label36 As Label
    Friend WithEvents num03 As TextBox
    Friend WithEvents Label37 As Label
    Friend WithEvents num02 As TextBox
    Friend WithEvents Label38 As Label
    Friend WithEvents num01 As TextBox
    Friend WithEvents Label39 As Label
    Friend WithEvents Label40 As Label
    Friend WithEvents RightPanel As Panel
    Friend WithEvents Button3 As Button
    Friend WithEvents txtWord As TextBox
    Friend WithEvents word3 As TextBox
    Friend WithEvents Label44 As Label
    Friend WithEvents word2 As TextBox
    Friend WithEvents Label45 As Label
    Friend WithEvents word1 As TextBox
    Friend WithEvents Label46 As Label
    Friend WithEvents Label47 As Label
    Friend WithEvents RsetPanel As Panel
    Friend WithEvents btnRSet As Button
